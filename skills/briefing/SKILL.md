...
description: "Use when the person asks for their morning briefing from the brain-kit vault, or when the scheduled briefing task starts: facts from the kit, the vault's own blocks, open questions, and one pull request for what gets recorded."
---
