...
function allSites() {
  ...
  const direct = [
    ...
    ...extractTranslatorCallSites(readSrc('src/hooks/stop.mjs'), 'src/hooks/stop.mjs'),
    ...
    ...extractTranslatorCallSites(readSrc('src/commands/update.mjs'), 'src/commands/update.mjs'),
